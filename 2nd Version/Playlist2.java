...
public class Playlist2
{
	...
	private ArrayList<AudioContent2> contents; // songs, books, or podcasts or even mixture
	
	// Constructor - Initialize variables to be used
	public Playlist2(String title)
	{
		// Initialize variables that are defined in Playlist class
		this.title = title;
		contents = new ArrayList<AudioContent2>();
	}
	...
	public void addContent(AudioContent2 content)
	{
		contents.add(content);
	}
	
	public ArrayList<AudioContent2> getContent()
	{
		return contents;
	}

	public void setContent(ArrayList<AudioContent2> contents)
	{
	...
	{
		Playlist2 otherPlaylist = (Playlist2) other;
