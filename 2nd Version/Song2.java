 ...
 */
public class Song2 extends AudioContent2 implements Comparable <Song2>  // implement the Comparable interface
{
	...
	public Song2(String title, int year, String id, String type, String audioFile, int length, String artist,
			String composer, Song2.Genre genre, String lyrics)
	{
